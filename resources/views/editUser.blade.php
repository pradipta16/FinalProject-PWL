...
<div class="container" style="padding-top: 70px">
    <div class="textCake" style="padding-top: 10px">
        <h2 style="text-align: center"><b>Edit Info User</b></h2>
      </div>
    <form action="/manageUser/update/{{$user->id}}" method="post">
        ...
        <button type="submit" name="edit" class="btn btn-info float-left" style="margin-bottom: 4%"><b>Ubah Data</b></button><br><br>
    </form>
</div>
@endsection